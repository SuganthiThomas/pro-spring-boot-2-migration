...
public class ToDoHandler {
    ...
    public Mono<ServerResponse> getToDo(ServerRequest request) {
        ...
        return toDo.flatMap(t -> ServerResponse.ok().contentType(MediaType.APPLICATION_JSON).body(fromObject(t))).switchIfEmpty(notFound);
    }
    ...
    public Mono<ServerResponse> newToDo(ServerRequest request) {
        ...
        return ServerResponse.ok().contentType(MediaType.APPLICATION_JSON).body(fromPublisher(toDo.flatMap(this::save), ToDo.class));
    }
