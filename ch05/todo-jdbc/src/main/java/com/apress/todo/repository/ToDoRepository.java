...
public class ToDoRepository implements CommonRepository<ToDo> {
    ...
    private static final String SQL_FIND_BY_ID = SQL_QUERY_FIND_ALL + " WHERE id = :id";
    private static final String SQL_UPDATE = SQL_QUERY_FIND_ALL + "UPDATE todo SET description = :description, modified = :modified, completed = :completed WHERE id = :id";
    ...
    private ToDo upsert(ToDo toDo, final String sql) {
    ...
    public ToDo findById(String id) {
        try{
            ...
            return this.jdbcTemplate.queryForObject(SQL_FIND_BY_ID, namedParameters, this.toDoRowMapper);
    ...
    public Iterable<ToDo> findAll() {
        return this.jdbcTemplate.query(SQL_QUERY_FIND_ALL, this.toDoRowMapper);
    }
}
