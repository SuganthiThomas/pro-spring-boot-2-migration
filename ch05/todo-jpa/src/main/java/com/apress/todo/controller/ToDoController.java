...
//      Instead of using the non-existing ToDoBuilder in this project/module. The endpoint has been modified to work
//      the deleteById method from the repository directly rather than toDoRepository.delete(ToDoBuilder.create().withId(id).build());
