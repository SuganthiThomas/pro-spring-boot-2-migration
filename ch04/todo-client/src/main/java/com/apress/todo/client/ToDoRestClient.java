...
public class ToDoRestClient {
    ...
    public ToDo setCompleted(String id) throws URISyntaxException {
        Map<String, String> params = new HashMap<>();
        params.put("id", id);
//        Because this project uses Spring Boot 3.x.x version, the server side needs to override a configuration
//        This configuration is the HiddenHttpMethodFilter -> spring.mvc.hiddenmethod.filter.enabled=true
